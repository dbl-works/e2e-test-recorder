...
export async function setupApp(element) {
  ...
  if (import.meta.env.VITE_WITH_FAKE_DATA) {
    dispatch(addTestStep(new TestStep("CLICK", { selector: "body button", content: 'Click' })));
    dispatch(addTestStep(new TestStep("CLICK", { selector: "form button", content: 'Submit' })));
    dispatch(addTestStep(new TestStep("CLICK", { selector: "form a", content: 'Visit' })));
    dispatch(addTestStep(new TestStep("CLICK", { selector: "form button", content: 'Submit' })));
  }
